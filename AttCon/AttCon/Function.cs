...
namespace AttCon
{
    class Function
    {
        ...
        /// <returns></returns>
        public static string GetComName(string fullName)
        {
            Regex regex = new Regex(@"com\d+", RegexOptions.IgnoreCase);
            return regex.Match(fullName).Value;
        }
        ...
        /// <summary>
        /// 枚举类型，用于判断radiobuttonGroup
        /// </summary>
        public enum radiobuttonpara
        {
            T1 = 0,
            T2 = 1,
            R11 = 2,
        ...
        /// <summary>
        /// 获取TextBox容器中的RadioButton的值
        /// </summary>
        /// <param name="tb"></param>
        /// <returns></returns>
        public static string GetRadioButtonText(GroupBox gb)
        {
            string str = null;
            for (int i = 0; i < gb.Controls.Count; i++)
            {
                RadioButton rb = gb.Controls[i] as RadioButton;
